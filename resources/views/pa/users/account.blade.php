...
<div class="card max-w-xl mx-auto p-6">
    ...
    <form action="{{ route('pa.account.update') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="username" id="username" value="{{ old('username', $user->username) }}" class="form-input w-full" required>
            @error('username')
        ...
        <div class="mb-4">
            ...
            <input type="password" name="new_password_confirmation" id="new_password_confirmation" class="form-input w-full">
        </div>
